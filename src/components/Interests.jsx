...
import { Users, Trophy, MessageSquare, Lightbulb, Zap, Music, Play, Pause, Disc, Globe, Plane, Utensils, Compass, CheckCircle2, Volume2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-600 text-base sm:text-lg">
            My music taste, hobbies, geopolitical curiosities, and leadership experiences outside pure engineering.
          </p>
        </div>

        {/* Music & Currently Exploring Highlight Banner */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-16 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-6 bg-slate-900 text-white rounded-3xl p-6 sm:p-8 shadow-xl border border-slate-800 flex flex-col justify-between relative overflow-hidden group"
          >
            {/* Ambient Record Glow */}
          ...
          {/* Currently Exploring Geopolitics / Political Side Highlight */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="lg:col-span-6 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-xs flex flex-col justify-between relative overflow-hidden group hover:border-blue-300 transition-all"
          >
            <div>
              ...
              <h4 className="text-2xl font-extrabold text-slate-900 font-outfit mb-3">
                Geopolitics & Political Dynamics
              </h4>

              <p className="text-sm text-slate-600 leading-relaxed mb-6">
                Fascinated by international relations, statecraft, global policy dynamics, and understanding political structures shaping technological & economic trends worldwide.
              </p>
            </div>
        ...
        {/* Section 1: Hobbies & Personal Pursuits Grid */}
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {interests.slice(1).map((item, idx) => {
        ...
        {/* Section 2: Non-Technical Leadership & Event Management */}
        <div>
          <h3 className="text-xl font-bold text-slate-900 font-outfit mb-8 flex items-center gap-2">
